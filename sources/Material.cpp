...
gee::Material::Material(const std::array<std::string, 6>& diffusePaths, const std::string& normalPath, const std::string& specularPath):
	diffuseTex{ diffusePaths, gee::Texture::ColorSpace::NON_LINEAR }, normalTex{ normalPath, gee::Texture::ColorSpace::LINEAR },
	specularTex{ specularPath, gee::Texture::ColorSpace::LINEAR }
{
	gee::hash_combine(hash, diffuseTex.hash(), normalTex.hash(), specularTex.hash());
}
